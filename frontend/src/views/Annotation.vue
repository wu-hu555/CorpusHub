<template>
    <div class="grid-container">
        ...
        <div class="main-content">
            ...
            <div v-if="rawText" class="textarea  textarea-warning textarea-lg  w-full h-32">
...
const tagList = reactive(['demographic', 'observation', 'condition', 'drug', 'measurement', 'measurement', 'measurement', 'measurement'])
